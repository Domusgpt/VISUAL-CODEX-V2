...
*   **Focus Review Chip:** A pill button marked “FOCUS” toggles the `focus-mode` class, dialing back card glows, status LED color, and grid overlays so copy reviews can happen without the full neon intensity.
...
*   **Focus Mode Toggle:** The focus chip updates live button text, announces the calmer preset through the status readout, and resets alongside the other controls so reviewers can jump between presentation-ready and analysis-friendly lighting.
