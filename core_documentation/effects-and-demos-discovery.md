...
## Next Sweep
1. Record scene-by-scene screenshots (depth, progress, parallax) and attach FPS metrics for the discovery worksheet.
2. Extend smoke tests to cover emitter cycling, layout presets, and progress scene transitions.
3. Outline Wave 3 discovery focusing on mega-demo navigation and parallax director telemetry.
